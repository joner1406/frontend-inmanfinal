...
import DashboardAprendiz from './components/DashboardAprendiz.vue'
...
export default {
  ...
  setup() {
    ...
    const currentComponent = computed(() => {
      ...
      const components = {
        dashboard: esAprendiz ? 'DashboardAprendiz' : 'DashboardView',
        equipos: 'EquiposView',
      ...
      return components[activeModule.value] || (esAprendiz ? 'DashboardAprendiz' : 'DashboardView');
    })
